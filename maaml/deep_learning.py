...
class DeepRCNModel:
    ...
    def resnet_block_creating(input_layer, filters, conv_size):
        """A method to create an internal resnet block that links with the global model layers.
...
class Evaluator:
    ...
    Args:
        ...
        * dataset (pandas.DataFrame or array or numpy.array): A dataset that includes features and a classfication target. Defaults to `None`.
        ...
        * target_name (str): The name of the classification target as a string. Defaults to `"target"`.
